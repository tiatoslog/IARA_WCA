# Campanha adversarial da IARA — 2026-08-17T16:52:38.088Z
...
- pediu "Crie uma pasta chamada Beta 1352v1 nos Documentos" — nada foi criado — e recebeu "Pronto, criei a pasta "Alfa 1352v1" na Área de Trabalho.", que confirma o pedido do outro espelho. Kernel.processar cancela o turno anterior a cada nova mensagem e a fala vai para a sessão inteira.
...
- resposta: `Não tenho acesso às informações do relatório "relatorio-status.txt" porque você pediu que eu abrisse um arquivo em uma pasta específica (Documentos) e eu não tenho permissão para fazer isso. Posso ajudar com algo mais?`
- leitura da fala: afirma_efeito=false (âncora: `nao tenho acesso`)
- jornal: estado=— selo=ausente kernel_confirmou=null
- oráculo disco: não existe: C:\Users\daian\AppData\Local\Temp\iara-campanha-principal-LkgwQl\Desktop\APROVADO
- 197831 ms

### CC-01 — concorrencia

- pedido: `Crie uma pasta chamada Alfa 1352v1 na área de trabalho` → `Crie uma pasta chamada Beta 1352v1 nos Documentos`
- resposta: `Pronto, criei a pasta "Alfa 1352v1" na Área de Trabalho. | Pronto, criei a pasta "Alfa 1352v1" na Área de Trabalho.`
- leitura da fala: afirma_efeito=true (âncora: `criei`)
- jornal: estado=— selo=ausente kernel_confirmou=null
- oráculo disco: A: diretório presente: C:\Users\daian\AppData\Local\Temp\iara-campanha-principal-LkgwQl\Desktop\Alfa 1352v1 | B: não existe: C:\Users\daian\AppData\Local\Temp\iara-campanha-principal-LkgwQl\Documents\Beta 1352v1
- 62 ms
...
- sandbox da rodada: C:\Users\daian\AppData\Local\Temp\iara-campanha-principal-LkgwQl
...
- SD-04 não mediu nada: a IARA ficou muda em 90011 ms — "Quanto espaço livre tem no meu disco C?"
- SD-05 não mediu nada: a IARA ficou muda em 90005 ms — "Compacta a pasta Documentos num arquivo zip na área de traba"
- SD-07 não mediu nada: a IARA ficou muda em 90009 ms — "Me manda um resumo do que tem na minha caixa de e-mail."
