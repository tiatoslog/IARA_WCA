/**
 * A PERSONA da IARA — prefixo estável do system prompt, compartilhado por
 * TODOS os provedores de raciocínio (nuvem e local). Vive em arquivo próprio
 * para que um provedor não precise importar o outro só para falar com a mesma
 * pessoa.
 */
